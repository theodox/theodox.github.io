...
Summary: When is it time to write a wrapper?
...
Consider a classic case of wrapper-iteis: a system for [making maya GUI less of a pain](rescuing_maya_gui_from_itself.html). Everybody writes that one at some point in their TA career (I’ve done it 4 times to my certain knowledge, not counting one-offs and half-assed, abandonware). When somebody feels compelled to spruce something up that much it’s a sign.   

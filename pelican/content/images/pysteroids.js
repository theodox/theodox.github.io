"use strict";
// Transcrypt'ed from Python, 2017-06-21 00:43:08
function pysteroids () {
    ...
    */
	...
	(function () {
		...
		var Audio = __class__ ('Audio', [object], {
			get __init__ () {return __get__ (this, function (self) {
				self.fire_rota = list ([audio.clip ('/images/344276__nsstudios__laser3.wav'), audio.clip ('/images/344276__nsstudios__laser3.wav'), audio.clip ('/images/344276__nsstudios__laser3.wav'), audio.clip ('/images/344276__nsstudios__laser3.wav')]);
				self.explosion_rota = list ([audio.clip ('/images/108641__juskiddink__nearby-explosion-with-debris.wav'), audio.clip ('/images/108641__juskiddink__nearby-explosion-with-debris.wav'), audio.clip ('/images/108641__juskiddink__nearby-explosion-with-debris.wav'), audio.clip ('/images/108641__juskiddink__nearby-explosion-with-debris.wav')]);
				self.thrust = audio.loop ('/images/146770__qubodup__rocket-boost-engine-loop.wav');
				self.fail = audio.clip ('/images/172950__notr__saddertrombones.mp3');
				self.thrust.play ();
				self.shoot_ctr = 0;
				self.explode_ctr = 0;
			});},
		...
		var Game = __class__ ('Game', [object], {
			get __init__ () {return __get__ (this, function (self, canvas, fullscreen) {
				...
				var v_center = canvas.offsetWidth / 2;
